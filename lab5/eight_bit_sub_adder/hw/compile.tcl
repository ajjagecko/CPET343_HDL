...
set project_name "eight_bit_sub_adder"
...
set_global_assignment -name TOP_LEVEL_ENTITY eight_bit_sub_adder
...
set_location_assignment PIN_AF9  -to switch_i[0]
set_location_assignment PIN_AF10 -to switch_i[1]
set_location_assignment PIN_AD11 -to switch_i[2]
set_location_assignment PIN_AD12 -to switch_i[3]
set_location_assignment PIN_AE11 -to switch_i[4]
set_location_assignment PIN_AC9  -to switch_i[5]
set_location_assignment PIN_AD10 -to switch_i[6]
set_location_assignment PIN_AE12 -to switch_i[7]
...
set_location_assignment PIN_AA14 -to btn_i

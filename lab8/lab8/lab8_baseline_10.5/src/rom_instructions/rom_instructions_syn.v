...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone II" ENABLE_RUNTIME_MOD="YES" INIT_FILE="../../sim/script/instructions.mif" INSTANCE_NAME="INST" NUMWORDS_A=32 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" RAM_BLOCK_TYPE="M4K" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=5 address_a clock0 q_a
...
module  rom_instructions_altsyncram1
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block3a_0.init_file = "../../sim/script/instructions.mif",
	...
	defparam
		...
		ram_block3a_1.init_file = "../../sim/script/instructions.mif",
	...
	defparam
		...
		ram_block3a_2.init_file = "../../sim/script/instructions.mif",
	...
	defparam
		...
		ram_block3a_3.init_file = "../../sim/script/instructions.mif",
	...
	defparam
		...
		ram_block3a_4.init_file = "../../sim/script/instructions.mif",
		ram_block3a_4.init_file_layout = "port_a",
		ram_block3a_4.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_4.mem_init0 = 32'h00000040,
	...
	defparam
		...
		ram_block3a_5.init_file = "../../sim/script/instructions.mif",
		ram_block3a_5.init_file_layout = "port_a",
		ram_block3a_5.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_5.mem_init0 = 32'h0000000A,
	...
	defparam
		...
		ram_block3a_6.init_file = "../../sim/script/instructions.mif",
		ram_block3a_6.init_file_layout = "port_a",
		ram_block3a_6.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_6.mem_init0 = 32'h00000114,
	...
	defparam
		...
		ram_block3a_7.init_file = "../../sim/script/instructions.mif",
		ram_block3a_7.init_file_layout = "port_a",
		ram_block3a_7.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_7.mem_init0 = 32'h00000144,
	...
	assign
		...
		wren_a = 1'b0;
endmodule //rom_instructions_altsyncram1

//synthesis_resources = M4K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  rom_instructions_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	rom_instructions_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	assign
		q_a = wire_altsyncram1_q_a;
endmodule //rom_instructions_altsyncram
//VALID FILE
...
`endif
	...
	rom_instructions_altsyncram	rom_instructions_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
